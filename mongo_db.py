...
class MongoDB:
    ...
    def search_questions(self, 
        ...
        """
        Search questions with flexible filtering. All conditions are combined with AND logic.
...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.info(f"Found {len(results)} medium difficulty questions about fluids/pressure in chapter_1")
