...
Uses RAGSystem from rag.py for all chunking, summarization, and ingestion functionality.
"""
import os
...
class EnhancedIngestionService:
    def __init__(self, qdrant_db: Optional[QdrantDB] = None, mongo_db: Optional[MongoDB] = None, llm_service: Optional[LLMService] = None):
        """
    ...
    def generate_chunk_summary(self, text: str, chapter_name: str = "", 
        ...
        """
        Generates a short summary (around 200 words) for a large chunk using Gemini.
        Delegates to RAGSystem.
    ...
    def ingest_document(self, file_path: str, class_id: str, chapter_id: str,
                       ...
                       subject_id: str, collection_name: str = "documents"):
        """
